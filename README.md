...
This plugin is forked from [@vitejs/plugin-legacy@1.6.2](https://github.com/vitejs/vite/tree/plugin-legacy%401.6.2/packages/plugin-legacy).

It is used to let sveltekit support legacy browsers.
